...
uint32_t pOverrides_fsk[] =
{
    ...
    (uint32_t)0x00038883,      // CC1350:18883
    ...
    (uint32_t)0x00FB88A3,      // CC1310 : FB88A3   CC1350:F688A3
#if (CCFG_FORCE_VDDR_HH)
    // TX power override
    // Tx: Set PA trim to max (in ADI0, set PACTL0=0xF8)
    ADI_REG_OVERRIDE(0,12,0xF8),
#endif
//  ajout?   ADI_HALFREG_OVERRIDE(0, 16, 0x7, 2),
    (uint32_t)0xFFFFFFFF,
};
...
rfc_CMD_PROP_RADIO_DIV_SETUP_t RF_cmdPropRadioDivSetup_fsk =
{
    ...
    .config.frontEndMode = 0x0,   //  CC1310:0   CC1350:2      0:(diff)-50   1(RFP):-59  2(RFN):-64
    .config.biasMode = 0x1,
    .config.analogCfgMode = 0x0,
    .config.bNoFsPowerUp = 0x0,
    .txPower = 0xAB3F,           // CC1310:0xA73F  CC1350:0xAB3F
