...
#define EEPROMSIZE       8           // pair, plus petite possible, pour économiser les cycles d'écriture. Max 255
#define EEPROM_REGIONS_BASE 0xFE000  // 2 derniers secteurs
#define SECTORSIZE       0x1000
#define SHEADERSIZE      2       // Header par enregistrement

// Hypothèses de bon fonctionnement
// L'unité d'effacement est le secteur
// Une valeur effacee est egale à 0xFF
// Le write se fait en 16 bits minimum (2 octets, équivaleur au header)
// Le read se fait en 8 bits minimum

// taille du code : 1684 octets
